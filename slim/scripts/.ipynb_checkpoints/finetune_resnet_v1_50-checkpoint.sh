...
TRAIN_DIR=/home/centos/new_ensemble_19_for_rcmp/rcmp-models/resnet_v1_50
MAX_STEP_1=1
MAX_STEP_2=1
# Where the dataset is saved to.
DATASET_DIR=/home/centos/new_ensemble_19_for_rcmp/data
DATASET_NAME=rcmp
...
python train_image_classifier.py \
  ...
  --max_number_of_steps=${MAX_STEP_1} \
  --batch_size=32 \
  --learning_rate=0.01 \
...
python train_image_classifier.py \
  ...
  --model_name=${MODEL_NAME} \
  --checkpoint_path=${TRAIN_DIR} \
  --max_number_of_steps=${MAX_STEP_2} \
  --batch_size=32 \
...
python eval_image_for_ensemble.py \
  --checkpoint_path=${TRAIN_DIR}/all \
  --eval_dir=${TRAIN_DIR}/all \
  --dataset_name=${DATASET_NAME} \
  --dataset_split_name=validation \
